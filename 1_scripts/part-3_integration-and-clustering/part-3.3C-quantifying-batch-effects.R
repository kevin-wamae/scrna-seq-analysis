...
#   • part-3.3A-merge-naive.R — supplies `merged_naive`, whose cluster
#     composition is quantified here.
...
ensure_dependencies(step = "part-3.3C-quantifying-batch-effects.R")
